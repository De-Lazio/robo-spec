...
class UpdateLocalComponentRequest extends FormRequest
{
    public function authorize(): bool
    {
        $project = $this->route('project');
        $component = $this->route('localComponent');

        if (! $project instanceof Project || ! $component instanceof Component) {
            return false;
        }

        return $component->owner_project_id === $project->getKey()
